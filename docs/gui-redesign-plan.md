...
### 已完成进度(2026-06-18)
P0 / P1 / P2 / P0R / P2.5 / P2.6 均已实现、打包目检通过并 commit 到 master(未 push)。

### 剩余实现顺序
P3(左栏 VSCode 式文件树双段) → P4(点击预览画布) → P5(二期叠加层)。
...
- **P3b**:复选框三态 + 文件夹联动子项;重定向 `startTranslation` 为"只翻译勾选项";基础单击预览。
